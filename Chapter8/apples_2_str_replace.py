...
def transform_message(message: str, vowel: str):
  if vowel != "a":
    message = message.replace("A", vowel.upper())
    message = message.replace("a", vowel)

  if vowel != "e":
    message = message.replace("E", vowel.upper())
    message = message.replace("e", vowel)

  if vowel != "i":
    message = message.replace("I", vowel.upper())
    message = message.replace("i", vowel)

  if vowel != "o":
    message = message.replace("O", vowel.upper())
    message = message.replace("o", vowel)

  if vowel != "u":
    message = message.replace("U", vowel.upper())
    message = message.replace("u", vowel)
