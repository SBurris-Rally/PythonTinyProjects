...
def create_args_parser():
  ...
  parser.add_argument("file",
                      ...
                      default=[sys.stdin],
                      help="Input file(s)")
  parser.add_argument("-l", "--lines", default=False, action="store_true", help="Display line count")
  parser.add_argument("-w", "--words", default=False, action="store_true", help="Display word count")
  parser.add_argument("-c", "--characters", default=False, action="store_true", help="Display characters count")
  return parser
